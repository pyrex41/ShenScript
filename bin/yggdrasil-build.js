...
if (manifest['kernel-version'] !== '42' && !manifest['kernel-version'].startsWith('42-')) {
  console.warn(`warning: manifest kernel-version is ${manifest['kernel-version']}, this builder targets 42`);
}
